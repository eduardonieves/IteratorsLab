...
public class CustomLinkedPositionalList<E> implements PositionalList<E> {
		...
		public CustomLinkedPositionalList() {
			header = new DNode<>(); 
			trailer = new DNode<>(); 
		...
		public CustomLinkedPositionalList(PLIteratorMaker<E> iteratorMaker) {
			header = new DNode<>(); 
			trailer = new DNode<>(); 
			header.setNext(trailer);
			trailer.setPrev(header); 
