...
import llPositionalList.CustomLinkedPositionalList;
...
public class LinkedPositionalListTester4 {
	...
	public static void main(String[] args) {
		...
		CustomLinkedPositionalList<Integer> list1 = new CustomLinkedPositionalList<>(new L2FIteratorMaker<Integer>()); 
	...
	private static void removeEvenValues(CustomLinkedPositionalList<Integer> list) {
	...
	private static void showList(String msg, CustomLinkedPositionalList<Integer> list) {
